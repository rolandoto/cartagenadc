          ...
          <div className="md:hidden block">
            {steps
                ...
                <div
                    ...
                    <span className="rounded-full w-5 h-5 text-xs flex items-center justify-center bg-yellow-500 text-white">
                    {step}
                    </span>
                    {label}
                </div>
                ...
                <React.Fragment key={step}>
                  <div
                    className={`flex items-center gap-1 ${
                      isCurrent ? "text-yellow-500 font-semibold" : "text-gray-500"
                    }`}
                  >
                    <span
