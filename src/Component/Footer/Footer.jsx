...
const Footer =() =>{
    ...
    const handleFacebook = () => {
        window.open("https://www.facebook.com/hotelcartagenadc/", "_blank");
    };

    const handleInstagram = () => {
        window.open("https://www.instagram.com/hotelcartagenadc/", "_blank");
    };
    ...
    return (
        ...
        <div>
            ...
            <ul className="space-y-2">
                            <li className="flex items-center"> <IconFaWhatsapp /> +57 3217384929</li>
                            <li className="flex items-center mr-6">  <IconsMdEmail />reservas@cartagenadc.com	</li>
                            <li className="flex items-center"> <IconFaMapMarkerAlt/>Trans 54 #30B - 67</li>
                        </ul>
            </div>
